...
Return[{K,Re[b],Re[a]}]]; (*can yield extremely small complex numbers so we take Re[]*)
...
{KdimMC, LanczosMC, aMC} = LanczosAlgoMC[HLMG, initialOp, 2S+1, nWindow, sizeWindow, 10^(-50), p];
